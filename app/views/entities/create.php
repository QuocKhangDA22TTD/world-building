...
<head>
    ...
    <title>Tạo Thực thể mới - World Building</title>
    ...
    <div class="container mt-4">
        ...
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0"><i class="fas fa-plus-circle"></i> Tạo Thực thể mới</h3>
            </div>
            <div class="card-body">
                <?php if ($world): ?>
                    <form action="/world-building/public/?url=entity/create" method="POST" id="createEntityForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" 
                                   placeholder="Ví dụ: Rồng Vàng, Excalibur, Vương quốc Elven..." 
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="type" name="type" required>
                                ...
                                <option value="Sinh vật">Sinh vật</option>
                                ...
                                <option value="Chủng tộc">Chủng tộc</option>
                        ...
                        <div class="form-group">
                            ...
                            <div id="attributesContainer">
                                ...
                                <div class="attribute-row mb-2">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control attribute-key" placeholder="Tên thuộc tính (vd: Tuổi, Sức mạnh...)">
                                        </div>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control attribute-value" placeholder="Giá trị (vd: 1000, Rất cao...)">
                                        </div>
                                        <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="article" name="article" rows="10"
                                      placeholder="Nhập mô tả chi tiết về thực thể..."></textarea>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary" id="submitBtn">
                                <i class="fas fa-save"></i> Tạo Thực thể
                            </button>
                            <a href="/world-building/public/?url=entity&world_id=<?= $world['world_id'] ?>" class="btn btn-secondary">
                ...
                <?php else: ?>
                    <div class="alert alert-danger">
                        <i class="fas fa-exclamation-triangle"></i> Không tìm thấy thông tin thế giới!
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <script>
        ...
        ClassicEditor
            .create(document.querySelector('#article'), {
                ...
                placeholder: 'Nhập mô tả chi tiết về thực thể...'
            })
            .then(newEditor => {
                editor = newEditor;
        ...
        document.getElementById('createEntityForm').addEventListener('submit', function(e) {
            // Lấy dữ liệu từ editor và lưu vào textarea ẩn
