...
<head>
    ...
    <title>Tạo Mối quan hệ mới - World Building</title>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0"><i class="fas fa-plus-circle"></i> Tạo Mối quan hệ mới</h3>
            </div>
            <div class="card-body">
                <?php if ($world): ?>
                    <?php if (count($entities) < 2): ?>
                        <div class="alert alert-warning">
                            ...
                            Cần có ít nhất 2 thực thể để tạo mối quan hệ. 
                            <a href="/world-building/public/?url=entity/create&world_id=<?= $world['world_id'] ?>" class="alert-link">
                                Tạo thực thể mới
                            </a>
                        </div>
                    <?php else: ?>
                        <form action="/world-building/public/?url=relationship/create" method="POST" id="createRelationshipForm">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="5"
                                          placeholder="Mô tả chi tiết về mối quan hệ giữa hai thực thể..."></textarea>
                                <small class="form-text text-muted">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" id="submitBtn">
                                    <i class="fas fa-save"></i> Tạo Mối quan hệ
                                </button>
                                <a href="/world-building/public/?url=relationship&world_id=<?= $world['world_id'] ?>" class="btn btn-secondary">
    ...
    <script>
        ...
        // Xử lý submit form
        document.getElementById('createRelationshipForm').addEventListener('submit', function(e) {
