...
<div class="max-w-2xl mx-auto">
    <h1 class="text-3xl font-bold text-theme-primary mb-6">Create Relationship - {{ $world->name }}</h1>

    <form method="POST" action="{{ route('relationships.store') }}" class="glass-card p-6 rounded-lg">
        @csrf
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('relationships.index', ['world_id' => $world->id]) }}" class="btn-secondary">
                Cancel
            </a>
